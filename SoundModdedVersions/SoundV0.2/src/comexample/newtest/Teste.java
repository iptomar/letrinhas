...
public class Teste extends Activity {
   ...
   int StartR, StopR, StartP, StopP, activity;
   
   public void bind(int StartR,int StopR,int StartP,int StopP,int activity){
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      startR = (Button)findViewById(StartR);
      stopR = (Button)findViewById(StopR);
      startP = (Button)findViewById(StartP);
      stopP = (Button)findViewById(StopP);
