...
/**
 * Classe para apoiar a activity de corrigir um teste de texto simples 
 * @author Thiago
 *
 */
public class Correcao_Texto extends Activity {
	 ...
	 *  caso o numero seja inferior a 10
	 * @param n Numero inteiro a ser verificado
	...
	public void marcaPalavra() { // Marcar Palavra Errada
		...
		// Associar a variavel TextoLido a Textview que contem o texto
		...
		if (startSelection != endSelection) {
			...
			for (int i = 0; i < ListaPalavrasErradas.size(); i++) {
				...
				// seleccionada
				// esta inserida no array, se sim guarda o valor da
				// posição
