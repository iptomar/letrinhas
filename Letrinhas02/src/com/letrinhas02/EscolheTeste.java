...
public class EscolheTeste extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/****************** falta testar ************************************
		 * Tentativa de criar um painel dinâmico para os botões de selecção
		...
		//guardar essa informação num array para se aceder na construção do scroll view
		...
		for (i=0;i<nTestes;i++){		
			...
			// texto se não seleccionado
			tg.setTextOff("O título do teste");
			//texto se seleccionado
			tg.setTextOn(i+" - "+"O título do teste");
		...
		//escondo / elimino o botão original	
